    ...
    inquirer
      ...
      .then((answers) => {
        ...
        for (let i = 0; i < this.vehicles.length; i++) {
          ...
          else if (this.vehicles[i].vin === this.selectedVehicleVin) { console.log('Towing is only available for trucks'); }
          }
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          for (let i = 0; i < this.vehicles.length; i++) {
            ...
            else if (this.vehicles[i].vin === this.selectedVehicleVin) { console.log('Wheelie is only available for motorbikes'); }
          }
        }
